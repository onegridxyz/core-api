...
class CoreApiApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<CoreApiApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(CoreApiApp::class.java)
